...
var Fintastic = function () {
	...
	_createClass(Fintastic, [{
		...
		key: "drawCandleChart",
		value: function drawCandleChart(priceData) {
			...
			var x_increment = this.canvas.width / this.priceData.length;
			for (var _x2 = 0; _x2 < this.priceData.length; _x2++) {

				this.drawCandle(this.priceData[_x2], _x2 * x_increment, this.canvas.height - this.priceData[_x2][2] / max * this.canvas.height);
			}
		}
	}, {
		key: "setScale",
